...
int main() {
  ...
  */
  ...
  printf ("Agora escolha DOIS do atributos da carta nº 1 você quer comparar? \n");
  printf ("1 - População \n");
  printf ("2 - Área \n");
  printf ("3 - PIB \n");
  ...
  printf ("-----------------------AVISO!!!----------------------- \n");
  printf ("------------------------------------------------------ \n");
  printf ("APENAS ao comparar a DENSIDADE POPULACIONAL o MENOR valor é considerado GANHADOR da comparação!!!");
  printf ("------------------------------------------------------ \n");
  printf ("------------------------------------------------------ \n");
  printf ("Digite o numero correspondente ao atributo que você quer comparar PRIMEIRO\n");
  scanf (" %d", &escolhamenu1);
  printf ("Digite o numero correspondente ao atributo que você quer comparar em SEGUNDO\n");
  scanf (" %d", &escolhamenu2);



  //inicio da lógica da comparação 
    switch (escolhamenu1)
    {
    case 1:
    ...
    //inicio da lógica da comparação 2 e atribui 1 para ganhou e 0 para perdeu
    switch (escolhamenu2)
    {
    case 1:
        if (populacao1 > populacao2){
    ...
    printf ("------------------------------------------------------ \n");
    printf ("------------------------------------------------------ \n");
  switch (escolhamenu1) //mostra o atributo escolhido primeiro das duas cartas
  {
    case 1: //população
  ...
  switch (escolhamenu2) //mostrar as escolhas do usuário
  {
    case 1: //população
    printf ("Você escolheu comparar a população \n");
    printf ("------------------------------------------------------ \n");
  ...
  //printf ("primeiro resultado atributo  %d\n", resultadoa1);
  //printf ("segundo resultado atributo  %d\n", resultadoa2);

  //calcular o resultado (atribuido o valor 1 ou 0 (ganhou/perdeu) as variaveis resultadoa1 e resultadoa2)

  if (resultadoa1 == 1 && resultadoa2 == 1){
    printf ("voce ganhou\n");
  } else if (resultadoa1 == 0 && resultadoa2 == 0){
    printf ("voce perdeu!!\n");
  } else if (resultadoa1 != resultadoa2) 
  printf ("houve empate em alguma das comparações!!!\n");
